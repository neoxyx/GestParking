...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-Panel"></i> Home</a></li>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-xs-6">                            
                            ...
                            <div class="small-box bg-green">
                                <div class="inner">
                                    <h3>INGRESOS</h3>
                                    <p>Registrar Ingreso de Vehiculo</p>
                                </div>
                                <div class="icon">
                                    <i class="ion ion-android-arrow-down"></i>
                                </div>
                                <a href="<?= base_url() ?>index.php/atm/in" class="small-box-footer">Registrar <i class="fa fa-arrow-circle-right"></i></a>
                            </div>                         
                        </div>
                        <div class="col-lg-6 col-xs-6">
                            <!-- small box -->
                            <div class="small-box bg-red">
                                <div class="inner">
                                    <h3>SALIDAS</h3>
                                    <p>Registrar Salida de Vehiculo</p>
                                </div>
                                <div class="icon">
                                    <i class="ion ion-android-arrow-up"></i>
                                </div>
                                <a href="<?= base_url() ?>index.php/atm/out" class="small-box-footer">Registrar<i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <!-- /.row -->
        ...
        <!-- AdminLTE Panel demo (This is only for demo purposes) -->
        <script src="<?= base_url() ?>assets/lte/dist/js/pages/Panel.js"></script>
