...
<html>
    <head>
        ...
        <title>GestParking | Cuadre Diario</title>
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    <table id="dataTable" class="table table-bordered">
                                        ...
                                        <tbody>
                                            <?php
                                            if ($datos && isset($datos)) {
                                                foreach ($datos as $dato) {
                                                    ?>                                                                                            
                                                    <tr>
                                                        <td><?= $dato->plate ?></td>
                                                        <td><?= $dato->date_in . " " . $dato->hour_in ?></td>
                                                        <td><?= $dato->date_out . " " . $dato->hour_out ?></td>
                                                        <td>$ <?= number_format($dato->totalpay, 0, ".", ","); ?></td>
                                                    </tr>
                                                    <?php
                                                }
                                            } else {
                                        ...
                                        <tfoot>
                                            <tr>
                                                <td colspan='2'> <span style="float:right;"id ='totalCaja'>dsada </span> </td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
            ...
            $(function () {
                $('#dataTable').DataTable({
                    ...
                    "footerCallback": function (row, data, start, end, display) {
                        ...
                        total_page = api.column(3, {page: 'current'}).data().reduce(function (a, b) {
                            return intVal(a) + intVal(b);
                        }, 0);

                        total_page = parseFloat(total_page);
                        total = parseFloat(total);
                        // Update footer
                        $('#totalCaja').html("<h3>Total Hoja: $ " + total_page.toFixed(0) + "/ Total Día: $ " + total.toFixed(0) + "</h3>");
                    },
                    buttons: [
