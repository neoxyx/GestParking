...
<html>
    <head>
        ...
        <title>GestParking | Editar Usuario</title>
                                    ...
                                    <form id="frmEditUser">                                       
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="hidden" name="id" value="<?= $dato->idUser?>">
                                                <input type="text" value="<?= $dato->name?>" class="form-control input-lg" disabled="">
                                            </div>
                                            <!-- /.input group -->
                                        </div>
                                        <!-- Usuario -->
                                        <div class="form-group">
                                            <label>Usuario:</label>
                                            <div class="input-group">
                                                <input type="text" value="<?= $dato->user?>" class="form-control input-lg" disabled="">
                                            </div>
                                            <!-- /.input group -->
                                        </div>
                                        <!-- Contraseña -->
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="passw" id="passw" class="form-control input-lg" required="">
                                            </div>
                                            <!-- /.input group -->
                                        </div>
                                        <!-- /.form group -->
        ...
        <script>
            $(function () {
                $("#frmEditUser").submit(function (event) {
                    ...
                    var url = "<?= base_url() ?>index.php/Users/update";
                    $.ajax({
                        type: "POST",
                        url: url,
