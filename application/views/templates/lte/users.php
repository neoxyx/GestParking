...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <button type="button" class="btn btn-success" data-toggle="modal" data-target="#form-user">Crear Usuario</button>
                    <ol class="breadcrumb">
                                        ...
                                        <tbody>
                                            <?php foreach ($users as $dato) { ?>                                                                                            
                                                <tr>
                                                    ...
                                                    <td><?= $dato->user ?></td>
                                                    <td><?= $dato->rol ?></td>
                                                    <td><a href="<?= base_url() ?>/index.php/Users/edit?id=<?= $dato->idUser ?>">Cambiar Contraseña</a></td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
        ...
        <!-- ./wrapper -->
        <!--Modal-->
        <div class="modal fade" id="form-user" tabindex="-1" role="dialog" aria-labelledby="formUser" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form method="post" action="javascript:addUser()" id="addUserForm" class="form-horizontal">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <label class="col-xs-5 control-label">Nombre Completo(*):</label>
                                <div class="col-xs-5">
                            ...
                            <div class = "form-group">
                                <label class = "col-xs-5 control-label">Rol(*):</label>
                                <div class = "col-xs-5">
                                    <select name="rol" id="rol" class="form-control" required>
                                        <?php
                                        foreach ($roles as $rol) {
                                            ?>
                                            <option value="<?= $rol->idRol ?>"><?= $rol->desc ?></option>
                                            <?php
                                        }
                                        ?>
                                    </select>
        ...
        <script>
            ...
            function addUser() {
                var url = '<?= base_url() ?>' + "index.php/Users/add_user";
                $.ajax({
                    url: url,
